...
def get_parser():
    ...
    parser.add_argument("--keep_last_epochs", type=int, default=10,
                        help="The number of models to save.")
    ...
    parser.add_argument("--bt_cl", type=bool_flag, default=False,
                        help="whether make the BT steps CL or not.")
    parser.add_argument("--diff_type", type=str, default="length",
                        help="The difficulty type, including - length, rarity, wordtrans")
    parser.add_argument("--diff_file_prefix", type=str, default=None,
                        help="The corresponding difficulty file")
    parser.add_argument("--competence_type", type=str, default='sqrt',
                        help="The corresponding difficulty file, sqrt, sigmoid, double_sqrt, lower_stair, "
                             "upper_stair_preserve_last")
    parser.add_argument("--c0", type=float, default=0.01,
                        help="The initialize parameter c0")
    parser.add_argument("--T", type=int, default=5000,
                        help="The competence finish steps")

    # self-paced parameters
    parser.add_argument("--ae_js", type=bool_flag, default=True,
                        help="whether use AE JS self-paced learning or not.")
    parser.add_argument("--bt_sp", type=bool_flag, default=True,
                        help="whether use BT Cosine self-paced learning or not.")
    parser.add_argument("--bt_sentence", type=bool_flag, default=True,
                        help="whether use BT Cosine self-paced learning at sentence level.")
    parser.add_argument("--bt_word", type=bool_flag, default=True,
                        help="whether use BT Cosine self-paced learning at word level.")

    # loss weight
    parser.add_argument("--exp_param", type=float, default=2,
                        help='the index of power for loss weighting')
    parser.add_argument("--sample_K", type=float, default=5,
                        help='the index of power for loss weighting')
